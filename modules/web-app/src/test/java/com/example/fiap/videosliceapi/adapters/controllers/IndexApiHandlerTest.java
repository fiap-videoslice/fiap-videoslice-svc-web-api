...
class IndexApiHandlerTest {
    ...
    void getClienteConectado_autenticado() throws Exception {
        com.example.fiap.archburgers.domain.auth.LoggedUser usuarioLogado = mock(com.example.fiap.archburgers.domain.auth.LoggedUser.class);
    ...
    void getClienteConectado_error() throws Exception {
        com.example.fiap.archburgers.domain.auth.LoggedUser loggedUser = mock(com.example.fiap.archburgers.domain.auth.LoggedUser.class);
